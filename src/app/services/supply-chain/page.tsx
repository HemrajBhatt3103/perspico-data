  ...
  const features = [
    {
      ...
      description: "Advanced forecasting models to anticipate demand and optimize inventory levels",
      icon: Target
    },
    {
      title: "Real-time Tracking",
      description: "End-to-end visibility of supply chain operations with live monitoring",
      icon: Activity
    },
    {
      title: "Optimization Algorithms",
      description: "AI-powered optimization for routing, scheduling, and resource allocation",
      icon: Zap
    },
    {
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link href="https://wa.me/447825247759?text=Hello%20Perspico%20Data%20team%2C%20I%E2%80%99d%20like%20to%20learn%20more%20about%20your%20supply%20chain%20services.">
