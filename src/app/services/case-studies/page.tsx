...
type Project = {
  ...
  category: 'bi' | 'automation' | 'ai' | 'data-engineering' | 'cloud';
  impact: string;
};

// Categorized projects array
const projects: Project[] = [
  {
    id: 'ldc-data-automation',
    title: 'Project LDC: Data Automation',
    company: 'Louis Dreyfus Company',
    duration: '12 Months',
    problem: 'Global operations relied heavily on manual Excel/VBA processes for procurement, sampling, and logistics reporting, leading to errors, delays and inconsistent data.',
    solution: [
      'Standardised 100,000+ rows of procurement & quality data',
      'Built automated reporting using SQL + Power Automate',
      'Developed Power BI dashboards across multiple teams',
      'Created Power Apps replacing manual Excel forms',
      'Implemented daily-refresh pipelines to unify data sources',
    ],
    results: ['Significantly improved reporting accuracy, audit readiness, and cross-team operational visibility.'],
    tools: 'Excel, VBA, SQL, Power BI, Power Apps, Power Automate',
    skills: 'Process Automation, Data Standardization, Dashboard Development',
    highlight: 'Reporting time reduced from 2 days to <1 hour',
    icon: Zap,
    category: 'bi',
    impact: 'Reporting time reduced from 2 days to <1 hour • Manual effort reduced by 60-70%'
  },
  {
    id: 'panda-salud-strategy',
    title: 'Panda Salud — Health Tech Analytics & Dashboards',
    company: 'Panda Salud',
    duration: '1 Year',
    problem: 'The company struggled with fragmented operational data, poor visibility, and manual reporting workflows.',
    solution: [
      'Built operational BI dashboards',
      'Improved UX/UI for data understanding',
      'Automated key workflows using SQL + Python',
    ],
    results: ['Enhanced decision-making and improved operational efficiency.'],
    tools: 'SQL, Python, MySQL, UX/UI Design',
    skills: 'Data Analysis, Automation, Strategic Planning, UX/UI',
    highlight: 'Improved UX • Automated workflows • Better data decisions',
    icon: Target,
    category: 'bi',
    impact: 'Improved UX • Automated workflows • Better data decisions'
  },
  {
    id: 'rappi-cashless-operations',
    title: 'Rappi Brazil — Cashless Operations Dashboards',
    company: 'Rappi',
    duration: '1 Year',
    problem: 'Managing a large network of cashless POS systems without operational visibility.',
    solution: [
      'Built performance dashboards for POS reliability',
      'Implemented data-driven monitoring workflows',
      'Trained retailers + managed ops team of 15',
    ],
    results: ['Reduced payment delays and improved POS operational stability.'],
    tools: 'SQL, Excel Automation, Jira, Power BI',
    skills: 'Data Analysis, Automation, Strategic Planning, Team Management',
    highlight: '500+ POS deployed • Faster transactions • Higher reliability',
    icon: CreditCard,
    category: 'bi',
    impact: '500+ POS deployed • Faster transactions • Higher reliability'
  },
  {
    id: 'latam-catalog-standardization',
    title: 'Rappi LATAM — Catalog Analytics & Data Quality Dashboards',
    company: 'Rappi',
    duration: '5 Years',
    problem: 'Inconsistent catalog data across 7 countries affecting customer experience.',
    solution: [
      'Built catalog performance dashboards',
      'Data validation automation (70% of manual checks)',
      'Standardised catalog workflows',
    ],
    results: ['Improved catalog accuracy, faster launches, better user search experience.'],
    tools: 'SQL, Python, Power BI, Tableau, Jira, KissFlow',
    skills: 'Data Analysis, Automation, Strategic Planning, UX/UI, Information Architecture, Team Leadership',
    highlight: '35-45% fewer catalog errors • 200,000+ SKUs corrected',
    icon: Globe,
    category: 'bi',
    impact: '35-45% fewer catalog errors • 200,000+ SKUs corrected'
  },
  {
    id: 'pits-depot-inventory',
    title: 'Pits Depot — Inventory Automation System',
    company: 'Pits Depot',
    duration: '1 Year',
    problem: 'Manual inventory tracking processes created errors and slow decision-making.',
    solution: [
      'Automated reporting built on PostgreSQL',
      'Developed Excel-VBA + SQL-based inventory logic',
    ],
    results: ['A faster, more accurate inventory and reporting system.'],
    tools: 'PostgreSQL, Excel VBA, SQL, MySQL',
    skills: 'Data Automation, Inventory Management, Strategic Alignment',
    highlight: 'Reporting time reduced by 50% • Increased stock accuracy',
    icon: Package,
    category: 'automation',
    impact: 'Reporting time reduced by 50% • Increased stock accuracy'
  },
  {
    ...
    duration: '6 Months',
    problem: 'Needed predictive systems for client/product recommendations and lifecycle optimisation.',
    solution: [
      'Built predictive AI agents',
      'Trained ML models using 20+ behavioural variables',
      'Automated segmentation workflows',
    ],
    results: ['More personalised product recommendations and improved lifecycle efficiency.'],
    tools: 'AWS full stack, Python, Java, Jenkins, Jira',
    skills: 'Predictive Modeling, AI Development, MLOps, Backend Development',
    highlight: '72% ML accuracy • Manual segmentation reduced by 90%',
    icon: Brain,
    category: 'ai',
    impact: '72% ML accuracy • Manual segmentation reduced by 90%'
  },
  {
    id: 'predictive-stock-model',
    title: 'Rappi LATAM — Predictive Stock Engine',
    company: 'Rappi',
    duration: '7 Years',
    problem: 'Retailers needed better demand forecasting and automated replenishment logic.',
    solution: [
      'Built ML demand forecasting models',
      'Automated recommendation engine',
    ],
    results: ['Improved GMV, inventory accuracy, and operational planning.'],
    tools: 'Python, Spark, Scikit-learn, TensorFlow',
    skills: 'Machine Learning, Predictive Modeling, Cross-functional Collaboration',
    highlight: 'GMV uplift of 18-25% • Stockouts reduced by ~30%',
    icon: TrendingUp,
    category: 'ai',
    impact: 'GMV uplift of 18-25% • Stockouts reduced by ~30%'
  },
  {
    id: 'query-optimization-snowflake',
    title: 'Snowflake Optimization & ETL Rebuild',
    company: 'Rappi',
    duration: '7 Years',
    problem: 'Complex SQL workloads and slow ETL pipelines delayed analytics.',
    solution: [
      'Rebuilt ETL workflows',
      'Optimized SQL',
      'Migrated datasets to Snowflake',
      'Integrated Power BI with Snowflake',
    ],
    results: ['Massive improvement in reporting speed and pipeline performance.'],
    tools: 'Snowflake, SQL, Power BI, Python, Airflow',
    skills: 'Data Engineering, ETL, Query Optimization, BI',
    highlight: 'Reports 80% faster • ETL pipelines 60% faster',
    icon: Database,
    category: 'data-engineering',
    impact: 'Reports 80% faster • ETL pipelines 60% faster'
  },
  {
    id: 'national-customs-platform',
    title: 'National Customs Data Layer',
    company: 'SNG Consultores',
    duration: '8 Months',
    problem: 'Needed a modernized backend data pipeline for national-level customs systems.',
    solution: [
      'ETL ingesting 2-3GB/day',
      'Log recovery & anomaly detection pipelines',
      'Multi-database architecture',
    ],
    results: ['Stable, large-scale data operations with reliable automation.'],
    ...
    highlight: '10M+ records • 250K logs/day • High-volume ETL ingestion',
    icon: Cloud,
    category: 'data-engineering',
    impact: '10M+ records • 250K logs/day • High-volume ETL ingestion'
  },
  {
    id: 'rappi-microservices',
    title: 'High-Scale Microservices Architecture',
    company: 'Rappi',
    duration: '7 Years',
    problem: 'Needed scalable systems to support rapid expansion of new products.',
    solution: [
      'Built 25+ microservices',
      'Designed relational + NoSQL databases',
      'Implemented CI/CD (Jenkins & GitHub Actions)',
    ],
    results: ['High-performance backend powering multiple Rappi verticals.'],
    ...
    highlight: '10K-30K requests/min • Deployment time reduced 2h → 10min',
    icon: Server,
    category: 'cloud',
    impact: '10K-30K requests/min • Deployment time reduced 2h → 10min'
  },
];

const categories = [
  { id: 'all', name: 'All Projects', icon: Globe, count: projects.length },
  { id: 'bi', name: 'BI & Dashboards', icon: BarChart3, count: projects.filter(p => p.category === 'bi').length },
  { id: 'automation', name: 'Automation', icon: Settings, count: projects.filter(p => p.category === 'automation').length },
  { id: 'ai', name: 'AI & ML', icon: Brain, count: projects.filter(p => p.category === 'ai').length },
  { id: 'data-engineering', name: 'Data Engineering', icon: Database, count: projects.filter(p => p.category === 'data-engineering').length },
  { id: 'cloud', name: 'Cloud & Backend', icon: Cloud, count: projects.filter(p => p.category === 'cloud').length },
];
  ...
  return (
    <div className="min-h-screen bg-gray-50 text-gray-900">
      ...
      <main className="pt-24 pb-20">
        {/* Hero Section */}
        <section className="relative text-center mb-12 px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Real business impact delivered through data engineering, automation, analytics, and intelligent systems.
            </p>
          </motion.div>
        </section>
          ...
          >
            {filteredProjects.map((project) => (
              <motion.div key={project.id} variants={cardVariants}>
                <Card className="group relative overflow-hidden border-0 shadow-lg hover:shadow-xl transition-all duration-300 bg-gradient-to-br from-white to-gray-50 h-full cursor-pointer hover:scale-[1.02]">
                  <div className="absolute -top-8 -right-8 w-24 h-24 bg-blue-500/5 rounded-full transition-transform duration-500 group-hover:scale-[4]"></div>
                  <div className="relative">
                    <CardHeader className="pb-3">
                      ...
                      <CardTitle className="font-heading text-lg leading-tight mb-2">
                        {project.title}
                      </CardTitle>
                    ...
                    <CardContent className="space-y-4">
                        ...
                        <ul className="space-y-2">
                          {project.solution?.map((s, i) => (
                            <li key={i} className="flex items-start">
                              ...
                              <span className="text-gray-600 leading-relaxed text-sm">{s}</span>
                            </li>
                          ))}
                        </ul>
                      </div>
                      ...
                      <div>
                        ...
                        <div className="bg-green-50 border border-green-200 rounded-lg p-3">
                          <p className="text-green-700 text-sm font-semibold leading-tight">
                            {project.impact}
                          </p>
                        </div>
                      </div>
