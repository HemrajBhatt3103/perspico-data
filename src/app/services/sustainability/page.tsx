...
export default function SustainabilityPage() {
  const features = [
    {
      ...
      description: "Comprehensive Environmental, Social, and Governance performance measurement",
      icon: Target
    },
    {
    ...
    },
    {
      ...
      description: "Quantify environmental impact and identify improvement opportunities",
      icon: TreePine
    }
  ]
  ...
  const technologies = [
    { name: "GHG Protocol", category: "Standards" },
    { name: "SASB", category: "Reporting Framework" },
    { name: "TCFD", category: "Climate Disclosure" },
    { name: "GRI", category: "Sustainability Standards" },
    ...
    <div className="min-h-screen bg-white text-gray-900">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <div className="flex items-center space-x-4 mb-6">
              ...
              <div>
                <Badge className="mb-2 bg-emerald-100 text-emerald-800 border-emerald-200">Core Service</Badge>
            ...
            <p className="text-xl text-gray-600 max-w-3xl">
              Track, measure, and optimize your environmental impact with comprehensive 
              ESG analytics and carbon footprint management solutions.
            </p>
          </motion.div>
        </div>
      </section>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <p className="text-lg text-gray-600 mb-6">
                Our Sustainability Analytics platform provides comprehensive tracking of Environmental, 
                Social, and Governance (ESG) metrics, enabling organizations to measure their environmental 
                impact accurately and make data-driven decisions for improvement.
              </p>
              <p className="text-lg text-gray-600 mb-8">
                From carbon footprint analysis to sustainability reporting, we help organizations 
                meet regulatory requirements, enhance brand reputation, and contribute to global 
              ...
              <div className="grid grid-cols-2 gap-6">
                <div className="flex items-center space-x-3">
                  ...
                  <span className="text-gray-700">Carbon Accounting</span>
                </div>
                <div className="flex items-center space-x-3">
                  <CheckCircle className="w-5 h-5 text-emerald-600" />
                  <span className="text-gray-700">ESG Reporting</span>
                </div>
                <div className="flex items-center space-x-3">
                  <CheckCircle className="w-5 h-5 text-emerald-600" />
            ...
            >
              <div className="relative rounded-2xl overflow-hidden shadow-2xl">
                <img 
                  src="/images/sustainability-analytics.png" 
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-6">
              Sustainability Analytics Features
            </h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Comprehensive tools for environmental impact management
            </p>
          </motion.div>
              ...
              <Card className="border-0 shadow-xl">
                ...
                <CardContent>
                  <p className="text-gray-600 mb-4">
                    "The sustainability analytics platform helped us reduce our carbon footprint by 25% 
                    while ensuring 100% regulatory compliance. The real-time monitoring capabilities 
                    have transformed our environmental management approach."
                  </p>
                  <div className="flex items-center space-x-4">
                    <div className="w-12 h-12 bg-gray-200 rounded-full"></div>
                    <div>
                      <div className="font-semibold">Chief Sustainability Officer</div>
                      <div className="text-sm text-gray-600">Multinational Corporation</div>
                    </div>
                  </div>
                </CardContent>
              </Card>
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-6">
              Compliance Standards & Technologies
            </h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Industry-leading frameworks for sustainability reporting
            </p>
          </motion.div>
